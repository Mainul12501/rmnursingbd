    ...
    <div class="offcanvas-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="d-flex justify-content-between canvas-footer">
                <a href="https://1.envato.market/6yDPxq" class="btn btn-primary" target="_blank">Buy Now</a>
                <a href="https://1.envato.market/MGEaN" class="btn btn-secondary"target="_blank">Our Portfolio</a>
        ...
        <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent-3">
            <div class="row w-100 mx-auto text-center">
                <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto w-100">
                    <img src="{{ asset('/') }}backend/build/assets/images/media/pngs/5.png"
