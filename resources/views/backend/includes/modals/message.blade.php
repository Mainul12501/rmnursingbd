                ...
                <div class="action-header clearfix">
                    <div class="float-start hidden-xs d-flex">
                        <div class="avatar avatar-lg rounded-circle me-3">
                            <img src="{{ asset('/') }}backend/build/assets/images/faces/6.jpg" class="rounded-circle user_img" alt="img">
                        </div>
                ...
                <div class="card-body msg_card_body">
                    ...
                    <div class="d-flex justify-content-start">
                        <div class="img_cont_msg">
                            <img src="{{ asset('/') }}backend/build/assets/images/faces/6.jpg" class="rounded-circle user_img_msg" alt="img">
                        </div>
                    ...
                    <div class="d-flex justify-content-end ">
                        ...
                        <div class="img_cont_msg">
                            <img src="{{ asset('/') }}backend/build/assets/images/faces/9.jpg" class="rounded-circle user_img_msg" alt="img">
                        </div>
                    </div>
                    <div class="d-flex justify-content-start ">
                        <div class="img_cont_msg">
