                    ...
                    <div>
                        ...
                        <div class="row mt-3">
                            @foreach($services as $service)
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="{{ asset($service->page_main_image ?? '') }}" alt="" class="card-img-top w-100 img-fluid"  style="height: 240px"/>
                                        <div class="card-body">
                                            <h3>{{ $service->name ?? '' }}</h3>
                                            <div>
                                                {!! str()->words($service->page_content, 30, '....') !!}
                                            </div>
                                            <div class="text-center mt-2">
                                                <a href="{{ route('service-details', ['companyServiceSlug' => $service->slug]) }}" class="btn btn-secondary">Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
